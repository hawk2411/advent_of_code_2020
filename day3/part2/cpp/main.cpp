...
int main() {
    ...
    results.push_back(countTrees(land_map, 1,1));
    results.push_back(countTrees(land_map, 3,1));
    results.push_back(countTrees(land_map, 5,1));
    results.push_back(countTrees(land_map, 7,1));
    results.push_back(countTrees(land_map, 1,2));
